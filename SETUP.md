...
6. Create a storage bucket named `content` and make it public
7. See `SUPABASE_SETUP_STEP_BY_STEP.md` for detailed instructions

### Google Drive API Configuration (for content import - optional)
```bash
