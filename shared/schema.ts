...
export const content = pgTable("content", {
  ...
  googleDriveId: text("google_drive_id"), // Optional - for legacy Google Drive content
  googleDriveUrl: text("google_drive_url"), // Optional - for legacy Google Drive content
  supabasePath: text("supabase_path"), // Path in Supabase Storage
  supabaseUrl: text("supabase_url"), // Public URL from Supabase Storage
